...
export const PROVIDER_DISPLAY_COPY = {
  ...
  'commandcode-go': {
    'zh-CN': { name: 'Command Code GO', description: 'GO 套餐专用：走官方 CLI 的通道发送请求。连接后自动获取模型。', badge: 'Coding' },
    'zh-TW': { name: 'Command Code GO', description: 'GO 方案專用：走官方 CLI 的通道傳送請求。連線後自動取得模型。', badge: 'Coding' },
    en: { name: 'Command Code GO', description: 'For the GO plan: sends through the official CLI\'s transport. Models are fetched when you connect.', badge: 'Coding' },
  },
  groq: {
